...
const dataButtons = [
  {
    ...
    classes: "bg-bgBtn_ hover:bg-green-800",
    href: FORMULARIO_SOLICITUD,
  },
  {
    text: "Adaptaciones realizadas",
    classes: "bg-bgBtn__ hover:bg-blue-800 mt-3 sm:mt-0",
  ...
  return (
    <>
      {href ? (
        <Link
          href={href}
          className={`inline-flex items-center justify-center rounded border border-transparent px-4 py-3 font-medium text-white focus:outline-none text-sm sm:text-base ${classes}`}
        >
          {text}
        </Link>
      ) : (
  ...
  return (
    <div className="bg-white shadow-lg sm:rounded-lg">
      <div className="px-4 py-6 sm:p-6">
        ...
        <div className="mt-2 max-w-xl text-sm text-bgBac text-center">
          <p>{text}</p>
        </div>
  ...
  return (
    <>
      <PageTitle
        ...
        name="Solicitar adaptación curricular "
        content="Solicitar adaptación curricular "
      />
      <LayoutPA
          ...
          <>
            {endS ? (
              ...
              <div className="py-4 text-bgBac">
                ...
                shadow hover:bg-orange-700 sm:px-8 max-w-fit text-white bg-bgBtn__ mt-4"
