...
const secondaryNavigation = [
  ...
  },
  {
    name: "Iniciar Sesión",
    href: "/iniciar_sesion",
    text: "text-white focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-base px-5 py-2.5 text-center md:mr-0 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-blue-800"
  }
]
                ...
                primaryNavigation.map((item) => (
                  <Link
                    ...
                    text-gray-600 flex flex-row
                      space-x-8 text-base font-medium items-center"
                  >
                    {item.name}
                  </Link>
                ))
            ...
            ">
              <div className="border-solid border-t-2 border-t-gray-200">
                <Popover.Button
                  ...
                  text-gray-400 mt-5 rounded-lg md:hidden hover:bg-gray-100
                    focus:outline-none focus:ring-2 focus:ring-gray-200
                  dark:text-gray-400">
