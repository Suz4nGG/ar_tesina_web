  ...
  <Document title={`AC_${nombreCompleto}`.toLowerCase().split(" ").join("_")}>
    <Page size="A4" style={styles.body}>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>Descripción del contrato de AC
Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla ultrices metus malesuada, vehicula leo id, efficitur odio. Nunc vulputate lacinia sem vel sollicitudin. Suspendisse erat eros, finibus viverra purus a, pulvinar pharetra ligula. Aliquam eget ex blandit, tempor odio ut, sodales nulla.</Text>
      </View>
      <View style={styles.section}>
